      ...
      <div className="w-2/3 flex items-center flex-col bg-gray-800 m-1 p-4 rounded-xl">
        ...
        <div className="w-full p-2">
          ...
          <div className="w-full flex place-content-center mb-4">
            {mic_on ? (
              <Button className="mr-6 px-1 bg-red-500 text-white rounded-full hover:bg-red-300 w-14 h-14 flex place-content-center" onClick={() => close_microphone()} >
              ...
              <Button className="mr-6 px-1 bg-slate-500 text-white rounded-full hover:bg-slate-400 w-14 h-14 flex place-content-center" onClick={() => open_microphone()} >
                {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8 place-self-center">
                  </svg> */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8 place-self-center">
                  <path d="M8.25 4.5a3.75 3.75 0 1 1 7.5 0v8.25a3.75 3.75 0 1 1-7.5 0V4.5Z" />
